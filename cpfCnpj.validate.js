...
(function ($) {
    $.validator.addMethod("cpf", function (value, element, type) {
        ...
        return (type === 'format' || (type === 'both' && !isCpfFormatted($(element).val()))) ? 'Formato do CPF n&atilde;o &eacute; v&aacute;lido' : 'CPF invalido';
    });
    $.validator.addMethod("cnpj", function (value, element, type) {
        ...
        return (type === 'format' || (type === 'both' && !isCnpjFormatted($(element).val()))) ? 'Formato do CNPJ n&atilde;o &eacute; v&aacute;lido' : 'CNPJ invalido';
    });
})(jQuery);